# Scénario 1 - Installation en mode Master autonome
...
| Mot de passe "root" MariaDB | `master.db.root.password` | `UuZ2CPALgqqX7lRR22L6` |
| Nom d'utilisateur "administrateur" MariaDB | `master.db.admin.username` | `alexiagossa` |
| Mot de passe "administrateur" MariaDB | `master.db.admin.password` | `6HNj5Tuilzo7rN5Oamcf` |
